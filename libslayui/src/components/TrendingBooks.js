                ...
                {books.map((item, i) => (
                    ...
                    >
                        ...
                        <div className='flex flex-col items-center  z-10 text-center text-white'>
                            <img className=" h-14 w-14  rounded-full " src={item.image}/>
                            <h2 className='text-sm m-0 text-black font-bold'>{item.name}</h2>
                            <span className=' text-black text-sm m-0'>{item.author}</span>
